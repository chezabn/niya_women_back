...
class IdentityVerificationRequest(models.Model):
    ...
    ai_score = models.FloatField(null=True, blank=True, help_text="Score de confiance IA (0-1)")
    ai_details = models.JSONField(null=True, blank=True, help_text="Détails bruts de l'analyse IA/API")
    ...
    rejection_reason = models.TextField(blank=True, help_text="Raison du rejet (visible par l'admin)")
    ...
    def approve(self, admin_user):
        ...
        self.user.email_verified = True  # On considère que l'identité valide l'email aussi
        self.user.save()
